...
public class VendorController {
	...
	@RequestMapping("/vendors/company/{companyName}")
	public List<Vendor> searchByCompany(@PathVariable("companyName") String companyName){
		return vendorService.searchByCompanyName(companyName);
	}
	
	@RequestMapping("/vendors/lookup/{emailId}")
	public List<Vendor> searchVendorByGST(@PathVariable("emailId") String emailId){
		return vendorService.lookupVendorByGST(emailId);
	}
